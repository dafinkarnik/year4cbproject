 ...
 protected:
  ...
  void SetUpRtpSender(bool pacer) {
    rtp_sender_.reset(new RTPSender(
        false, &fake_clock_, &transport_, nullptr, pacer ? &mock_paced_sender_ : nullptr,
...
TEST_P(RtpSenderTestWithoutPacer,
  ...
  rtp_sender_.reset(new RTPSender(
      false, &fake_clock_, &transport_, nullptr, nullptr, nullptr, &seq_num_allocator_,
...
TEST_P(RtpSenderTest, SendRedundantPayloads) {
  ...
  rtp_sender_.reset(new RTPSender(
      false, &fake_clock_, &transport, nullptr, &mock_paced_sender_, nullptr, nullptr,
...
TEST_P(RtpSenderTest, SendFlexfecPackets) {
  ...
  rtp_sender_.reset(new RTPSender(
      false, &fake_clock_, &transport_, nullptr, &mock_paced_sender_, &flexfec_sender,
...
TEST_P(RtpSenderTestWithoutPacer, SendFlexfecPackets) {
  ...
  // Reset |rtp_sender_| to use FlexFEC.
  rtp_sender_.reset(new RTPSender(false, &fake_clock_, &transport_, nullptr, nullptr,
...
TEST_P(RtpSenderTest, FrameCountCallbacks) {
  ...
  rtp_sender_.reset(
      new RTPSender(false, &fake_clock_, &transport_, nullptr, &mock_paced_sender_,
...
class RtpSenderAudioTest : public RtpSenderTest {
 protected:
  ...
  void SetUp() override {
    ...
    rtp_sender_.reset(new RTPSender(true, &fake_clock_, &transport_, nullptr, nullptr,
...
TEST_P(RtpSenderTest, OnOverheadChanged) {
  ...
  rtp_sender_.reset(
      new RTPSender(false, &fake_clock_, &transport_, nullptr, nullptr, nullptr, nullptr,
...
TEST_P(RtpSenderTest, SendAudioPadding) {
  ...
  rtp_sender_.reset(new RTPSender(
      kEnableAudio, &fake_clock_, &transport, nullptr, &mock_paced_sender_, nullptr,
...
TEST_P(RtpSenderTest, SendsKeepAlive) {
  MockTransport transport;
  rtp_sender_.reset(new RTPSender(false, &fake_clock_, &transport, nullptr, nullptr,
                                  nullptr, nullptr, nullptr, nullptr, nullptr,
