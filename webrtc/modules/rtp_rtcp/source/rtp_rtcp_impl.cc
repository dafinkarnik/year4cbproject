...
void ModuleRtpRtcpImpl::PushRtcpIntervalToCb(uint32_t rtcp_interval, uint32_t rtcp_interval_at_receiver_estimate) {
	if (rtp_sender_)
		rtp_sender_->PushRtcpIntervalToCb(rtcp_interval, rtcp_interval_at_receiver_estimate);
}
