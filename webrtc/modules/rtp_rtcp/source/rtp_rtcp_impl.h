...
class ModuleRtpRtcpImpl : public RtpRtcp, public RTCPReceiver::ModuleRtpRtcp {
 public:
  ...
  // Supplies the Circuit Breaker with the RTCP interval, called each time it has been recalculated			
  void PushRtcpIntervalToCb(uint32_t rtcp_interval, uint32_t rtcp_interval_at_receiver_estimate);
